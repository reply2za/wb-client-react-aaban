...
function getTranslateValue(direction, node) {
  ...
  var containerWindow = (0, _utils3.ownerWindow)(node);
  var transform;
  ...
  if (direction === 'left') {
    return "translateX(".concat(containerWindow.innerWidth, "px) translateX(").concat(offsetX - rect.left, "px)");
  }
  ...
  if (direction === 'up') {
    return "translateY(".concat(containerWindow.innerHeight, "px) translateY(").concat(offsetY - rect.top, "px)");
  } // direction === 'down'
...
var Slide = /*#__PURE__*/React.forwardRef(function Slide(props, ref) {
  ...
  var handleRefIntermediary = (0, _useForkRef.default)(children.ref, childrenRef);
  ...
  React.useEffect(function () {
    ...
    var containerWindow = (0, _utils3.ownerWindow)(childrenRef.current);

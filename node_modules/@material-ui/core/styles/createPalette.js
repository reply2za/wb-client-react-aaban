...
function createPalette(palette) {
  var _palette$primary = palette.primary,
    ...
    dark: _green.default[700]
      ...
      other = (0, _objectWithoutProperties2.default)(palette, ["primary", "secondary", "error", "warning", "info", "success", "mode", "contrastThreshold", "tonalOffset"]); // Use the same logic as

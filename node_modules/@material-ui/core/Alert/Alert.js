...
var styles = function styles(theme) {
  var getColor = theme.palette.mode === 'light' ? _colorManipulator.darken : _colorManipulator.lighten;
  var getBackgroundColor = theme.palette.mode === 'light' ? _colorManipulator.lighten : _colorManipulator.darken;
  return {
...
var Alert = /*#__PURE__*/React.forwardRef(function Alert(props, ref) {
  ...
  return /*#__PURE__*/React.createElement(_Paper.default, (0, _extends2.default)({
    ...
    square: true,
    elevation: 0,
    className: (0, _clsx.default)(classes.root, classes[variant], classes["".concat(variant).concat((0, _capitalize.default)(color || severity))], themeVariantsClasses, className),
    ref: ref

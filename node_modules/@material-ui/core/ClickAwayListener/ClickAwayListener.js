...
function ClickAwayListener(props) {
  ...
  var handleRef = (0, _useForkRef.default)(children.ref, nodeRef); // The handler doesn't take event.defaultPrevented into account:
  //
  ...
  var handleClickAway = (0, _useEventCallback.default)(function (event) {
    ...
    var doc = (0, _ownerDocument.default)(nodeRef.current); // 1. IE 11 support, which trigger the handleClickAway even after the unbind

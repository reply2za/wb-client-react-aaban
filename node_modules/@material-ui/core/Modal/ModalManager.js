...
function ariaHiddenSiblings(container, mountElement, currentElement) {
  ...
  var blacklist = [mountElement, currentElement].concat((0, _toConsumableArray2.default)(elementsToExclude));
...
function handleContainer(containerInfo, props) {
  ...
  if (!props.disableScrollLock) {
    if (isOverflowing(container)) {
      ...
      var scrollbarSize = (0, _getScrollbarSize.default)((0, _ownerDocument.default)(container));
      restoreStyle.push({
      ...
      var fixedElements = (0, _ownerDocument.default)(container).querySelectorAll('.mui-fixed');
    ...
    var containerWindow = (0, _ownerWindow.default)(container);
